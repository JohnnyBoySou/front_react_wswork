...
interface CarEmptyProps {
    onAddCar: () => void;
}

export default function CarEmpty({ onAddCar }: CarEmptyProps) {
    return (
        <div className="flex flex-col items-center justify-center py-12 px-6">
            <div className="text-center">
                ...
                <p className="text-gray-500 mb-6 max-w-md">
                    Comece adicionando seu primeiro carro para gerenciar sua frota de veículos.
                </p>
